...
const OptionCard: FC<OptionCardProps> = ({
  ...
  return (
    <div className={cn(
      ...
      { "hover:bg-[rgba(12,17,28,0.56)]": type === "silver" },

      // gold hover
      { "[border-image-source:radial-gradient(50%_100%_at_50%_0%,#FAA300_0%,rgba(250,163,0,0)_100%)]": type === "gold" },
      // gold hover border
      { "hover:[border-image-source:radial-gradient(50%_100%_at_50%_0%,#7F8D9F_6%,rgba(127,141,159,0)_94%)] hover:bg-[rgba(12,17,28,0.56)]": type === "gold" },
    )}>
      ...
      <span
        className={cn(`
          ...
          // backdrop hover styles
          { "[background:radial-gradient(45%_100%_at_50%_0%,#6325C8_20%,#1A0933_70%,transparent_100%)]": type === "cs" },
          { "[background:radial-gradient(50%_100%_at_50%_0%,rgba(99,66,2,0.56)_0%,rgba(0,0,0,0.0)_100%)]": type === "gold" },
          { "[background:radial-gradient(50%_100.32%_at_50%_0%,rgba(71,85,102,0.56)_0%,rgba(12,17,28,0.0)_100%)]": type === "silver" }
        )}
      />
