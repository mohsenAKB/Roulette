...
interface PrimaryHighlightedButtonProps extends BaseButtonProps { }

const PrimaryHighlightedButton: FC<PrimaryHighlightedButtonProps> = ({ children, className, ...props }) => {
  return (
    <PrimaryButton
      {...props}
    >
...
export default PrimaryHighlightedButton
